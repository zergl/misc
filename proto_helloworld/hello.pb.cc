...
void protobuf_AssignDesc_hello_2eproto() {
  ...
  static const int Helloworld_offsets_[4] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Helloworld, username_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Helloworld, password_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Helloworld, email_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Helloworld, grade_),
  };
...
void protobuf_AddDesc_hello_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\013hello.proto\022\007pb_test\"N\n\nHelloworld\022\020\n\010"
    "username\030\001 \002(\t\022\020\n\010password\030\002 \002(\t\022\r\n\005emai"
    "l\030\003 \001(\t\022\r\n\005grade\030\004 \003(\r", 102);
...
#ifndef _MSC_VER
const int Helloworld::kUsernameFieldNumber;
const int Helloworld::kPasswordFieldNumber;
const int Helloworld::kEmailFieldNumber;
const int Helloworld::kGradeFieldNumber;
#endif  // !_MSC_VER

Helloworld::Helloworld()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:pb_test.Helloworld)
}
...
Helloworld::Helloworld(const Helloworld& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:pb_test.Helloworld)
}
...
Helloworld::~Helloworld() {
  // @@protoc_insertion_point(destructor:pb_test.Helloworld)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:pb_test.Helloworld)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:pb_test.Helloworld)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:pb_test.Helloworld)
  return false;
#undef DO_
}
...
void Helloworld::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:pb_test.Helloworld)
  // required string username = 1;
  if (has_username()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->username().data(), this->username().length(),
  ...
  // @@protoc_insertion_point(serialize_end:pb_test.Helloworld)
}

::google::protobuf::uint8* Helloworld::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:pb_test.Helloworld)
  // required string username = 1;
  if (has_username()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->username().data(), this->username().length(),
  ...
  for (int i = 0; i < this->grade_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteUInt32ToArray(4, this->grade(i), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:pb_test.Helloworld)
  return target;
}
